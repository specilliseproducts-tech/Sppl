...
export const metadata = {
  title: "Contact Us | Spécialisé Products",
  description: "Get in touch with Spécialisé Products to discuss your customized solution needs.",
}
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-muted-foreground mb-8">
                  We're here to help with your customized solution needs. Contact us today to discuss how we can help
                  you.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">mridulverma@specialiseproducts.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <ul className="text-muted-foreground space-y-2">
                    ...
                    <li>
                      <span className="font-medium">Saturday:</span> 9:00 AM - 1:00 PM IST
                    </li>
                    <li>
      ...
      <section className="w-full py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="rounded-xl overflow-hidden h-96 bg-card flex items-center justify-center">
            ...
            <div className="text-muted-foreground">Map will be displayed here</div>
          </div>
        </div>
      </section>
    </>
