...
export const products = [
  {
    ...
    shortDescription: "Handheld machine for metallic and silicon substrate with ≤ 100 µm microchannel width and depth.",
    description: `
    ...
    applications: ["Microchannel mould Fabrication", "Useful for Field use (on site)", "Easily transportable"],
  ...
  },
  {
    ...
    applications: ["Photo Thermal Studies", "Biomedical Research", "Material Science", "Thermal Analysis"],
  ...
  },
  {
    ...
    shortDescription: "Fully customizable marking, engraving & cutting machine based on Fibre or CO2 Laser.",
    description: `
  ...
  },
  {
    ...
    shortDescription: "3D printing solutions with customizable build volumes and high temperature capabilities.",
    description: `
  ...
  },
  {
    ...
    shortDescription: "Selective deposition and curing of material droplets for precise 3D printing.",
    description: `
  ...
  },
  {
    ...
    shortDescription: "10 Gbps outdoor FSO communications setup with auto alignment feature.",
    description: `
...
export const processSteps = [
  {
    ...
    description: "Initial discussion with prospects on what is needed and what they imagine about their solution.",
  },
  {
    number: "02",
    title: "Broad Outline",
    description: "Make broad outline on what is practical & possible based on customer requirements.",
  },
  {
    number: "03",
  ...
  },
  {
    number: "07",
    title: "Manufacturing",
    description: "Once Final Design is completed, we proceed with manufacturing.",
  },
  {
    number: "08",
    title: "Feedback Process",
    description: "We call customer to see the manufactured system and request for feedback.",
  },
  {
    number: "09",
    title: "Delivery",
  ...
  },
  {
    ...
    description: "We visit customer for installation & training, and assure long-term support.",
  },
]
...
export const strengths = [
  {
    ...
    description: "We work interactively with customers to understand their needs and create tailored solutions.",
  },
  {
    icon: "Flag",
    title: "Indian OEM & SI",
  ...
  },
  {
    ...
    description: "Our team has deep technical knowledge across multiple domains including lasers, optics, and imaging.",
  },
  {
    icon: "Shield",
    title: "Quality Assurance",
    description: "We follow rigorous design reviews and quality checks to ensure high-performance products.",
  },
  {
    icon: "HeartHandshake",
    title: "Long-term Support",
    description: "We provide installation, training, and ongoing support for all our products and solutions.",
  },
]
